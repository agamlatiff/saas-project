      ...
      <main className="w-full max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-8 z-10">
        ...
        <div className="flex flex-col justify-center text-slate-800">
          ...
          <p className="mt-4 text-slate-600 max-w-md">
            Higher is more than just a SaaS and technology template—it&#39;s a
            ...
            <div className="flex items-start gap-4">
              <div>
                <blockquote className="text-slate-600 italic">
                  &quot;Higher has truly transformed our online presence. With
                  its powerful analytics and seamless integration, we&#39;ve
                  gained invaluable insights and improved our SEO ranking,
                  resulting in significant business growth.&quot;
                </blockquote>
                <div className="flex items-center gap-4 mt-6">
                  <Image
                    src="/assets/avatar-contact.jpg"
                    alt="Fig Nelson"
                    width={56}
                    height={56}
